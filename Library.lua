...
do
    ...
    Assets.Functions.LoadFile = function(file : string, githublink : string)
        if Void.Dev and isfile(file) then
    ...
    Assets.Functions.GetModule = function(name: string)
        if name and Void and Void.Tabs and Void.Tabs.Tabs then
            for i,v in Void.Tabs.Tabs do
    ...
    Assets.Functions.GetAllModules = function()
        local modules = {}
        if Void and Void.Tabs and Void.Tabs.Tabs then
            for i,v in Void.Tabs.Tabs do
                if v.Modules then
...
do
    Assets.Config.Save = function(File, data)
        writefile("Void/Config/"..File..".json", HttpService:JSONEncode(data))
    end
    
    Assets.Config.Load = function(File, set)
        if isfile("Void/Config/"..File..".json") then
            local data = readfile("Void/Config/"..File..".json")
            local data2 = HttpService:JSONDecode(data)
            if set then
                Void.Config[set] = data2
                if set == "Game" then
                    ...
                    if Void.Config.Game.Other.TabPos then
                        for i,v in Void.Tabs.Tabs do
                            local tabpos = Void.Config.Game.Other.TabPos[i]
...
do
    ...
    Assets.Font.Download = function(Name: string, Font: string)
        ...
        if not isfile("Void/Assets/Fonts/"..Name..".ttf") then
            if data and not tostring(data):find("404") then
                writefile("Void/Assets/Fonts/"..Name..".ttf", data)
            else
                return false
            end
        end
    ...
    Assets.Font.create_family = function(name: string, faces: { FontFace })
        ...
        writefile("Void/Assets/Fonts/"..name..".json", HttpService:JSONEncode(family))

        local id = getcustomasset("Void/Assets/Fonts/"..name..".json")
...
do
    ...
    Assets.Notifications.Send = function(data: any)
        ...
        for i, v in Void.Notifications.Active do
        ...
        NotificationData.Objects.Notification = Instance.new("ImageButton", Void.Notifications.Objects.NotificationGui)
        ...
        NotificationData.Functions.Remove = function(anim: boolean)
            if not Void or not Void.Notifications or not Void.Notifications.Active then return end
            for i,v in NotificationData.Connections do
                v:Disconnect()
                if table.find(Void.Connections, v) then
                    table.remove(Void.Connections, table.find(Void.Connections, v))
                end
            end
            ...
            if Void and Void.Notifications and Void.Notifications.Active then
                Void.Notifications.Active[flag] = nil
            end
        ...
        table.insert(Void.Connections, NotificationData.Connections.conhover)
        table.insert(Void.Connections, NotificationData.Connections.unconhover)
        table.insert(Void.Connections, NotificationData.Connections.closecon)
        ...
        if Void.Notifications.Active[flag] then
            flag = NotificationData.Description..tostring(math.random(0, 1000000000))
            Void.Notifications.Active[flag] = NotificationData
        else
            Void.Notifications.Active[flag] = NotificationData
        end
        ...
        task.spawn(function()
            repeat 
                TimeLineBar.Size = UDim2.new((os.clock() - start) / Void.Notifications.Active[flag].Duration, 0, 0, 2)
                task.wait()
            until Void and Void.Notifications and Void.Notifications.Active[flag] and (os.clock() - start) >= Void.Notifications.Active[flag].Duration or Void and Void.Notifications and Void.Notifications.Active and not Void.Notifications.Active[flag] or not Void or not Void.Notifications
            if Void and Void.Notifications and Void.Notifications.Active and Void.Notifications.Active[flag] then
...
do    
    Assets.MainBackground.Init = function()
        ...
        Void.Notifications.Objects.NotificationGui = Instance.new("ScreenGui", Assets.Functions.gethui())
        Void.Notifications.Objects.NotificationGui.ResetOnSpawn = false
        Void.Notifications.Objects.NotificationGui.IgnoreGuiInset = true
        Void.Notifications.Objects.NotificationGui.DisplayOrder = 10000
        if Void.Mobile then
            Instance.new("UIScale", Void.Notifications.Objects.NotificationGui).Scale = Void.Config.UI.Scale
        end

        Void.ArrayList.Objects.ArrayGui = Instance.new("ScreenGui", Assets.Functions.gethui())
        Void.ArrayList.Objects.ArrayGui.ResetOnSpawn = false
        Void.ArrayList.Objects.ArrayGui.DisplayOrder = 10000
        Void.ArrayList.Objects.ArrayGui.Enabled = false
        if Void.Config.UI.ArrayList == nil then
            Void.Config.UI.ArrayList = false
        end
        ...
        InitInfo.Objects.MainScreenGuiScale.Scale = Void.Config.UI.Scale
        ...
        InitInfo.Objects.MainFrame.Position = UDim2.fromScale(Void.Config.UI.Position.X, Void.Config.UI.Position.Y)
        InitInfo.Objects.MainFrame.Size = UDim2.fromScale(Void.Config.UI.Size.X, Void.Config.UI.Size.Y)
        ...
        table.insert(Void.Corners, mainframecorner)
        ...
        if Void.Mobile then
            InitInfo.Objects.ToggleButton = Instance.new("ImageButton", Void.Notifications.Objects.NotificationGui)
            ...
            local VoidIcon = Instance.new("ImageLabel", InitInfo.Objects.ToggleButton)
            VoidIcon.AnchorPoint = Vector2.new(0.5, 0.5)
            VoidIcon.BackgroundTransparency = 1
            VoidIcon.Position = UDim2.fromScale(0.5, 0.5)
            VoidIcon.Size = UDim2.fromScale(0.5, 0.5)
            VoidIcon.Image = "rbxassetid://88680068080114"
            Instance.new("UICorner", InitInfo.Objects.ToggleButton).CornerRadius = UDim.new(1, 0)
    
            table.insert(Void.Connections, InitInfo.Objects.ToggleButton.MouseButton1Click:Connect(function()
            ...
            InitInfo.Functions.CreateMobileButton = function(info)
                ...
                local dragcon = button.InputBegan:Connect(function(input)
                    if (input.UserInputType == Enum.UserInputType.MouseButton1) or (input.UserInputType == Enum.UserInputType.Touch) then
                        ...
                        Void.InputEndFunc = function(input)
                            if (input.UserInputType == Enum.UserInputType.MouseButton1) or (input.UserInputType == Enum.UserInputType.Touch) then
                                local hold = (tick()-HoldTime) >= 0.8
                                MobileButtonInfo.Callbacks.End(MobileButtonInfo, hold)
                                HoldTime = 0
                                Void.CurrntInputChangeCallback = function() end
                                Void.InputEndFunc = nil
                                ...
                                if hold then
                                    ...
                                    if not Void.Config.Game.Other.MobileButtonPos then 
                                        Void.Config.Game.Other.MobileButtonPos = {}
                                    end

                                    Void.Config.Game.Other.MobileButtonPos[MobileButtonInfo.Flag] = {X = FrameStarting.X.Scale, Y = FrameStarting.Y.Scale}
                                    Assets.Config.Save(Void.GameSave, Void.Config.Game)
                                end
                            end
                        end
                        ...
                        if HoldTime >= 0.8 then
                            ...
                            Void.CurrntInputChangeCallback = function(input)
                                if (input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch) then  
                                    if MobileButtonInfo.Data.Dragging and not Void.Config.UI.FullScreen then
                ...
                table.insert(Void.Connections, dragcon)
                table.insert(MobileButtonInfo.Connections, dragcon)

                if Void.Config.Game.Other.MobileButtonPos and Void.Config.Game.Other.MobileButtonPos[MobileButtonInfo.Flag] then
                    local pos = Void.Config.Game.Other.MobileButtonPos[MobileButtonInfo.Flag]
                    if pos.X then
        ...
        table.insert(Void.Connections, ZoomFrame.MouseWheelForward:Connect(function()
            if UserInputService:IsKeyDown(Enum.KeyCode.LeftControl) or UserInputService:IsKeyDown(Enum.KeyCode.RightControl) and Void.Background.Objects.MainFrame.Visible then
                Void.Config.UI.Scale = Void.Config.UI.Scale + 0.05
                if Void.Config.UI.Scale > 3 then
                    Void.Config.UI.Scale = 3
                end
                InitInfo.Objects.MainScreenGuiScale.Scale = Void.Config.UI.Scale
                Assets.Config.Save("UI", Void.Config.UI)
            end
        end))
    
        table.insert(Void.Connections, ZoomFrame.MouseWheelBackward:Connect(function()
            if UserInputService:IsKeyDown(Enum.KeyCode.LeftControl) or UserInputService:IsKeyDown(Enum.KeyCode.RightControl) and Void.Background.Objects.MainFrame.Visible then
                Void.Config.UI.Scale = Void.Config.UI.Scale - 0.05
                if Void.Config.UI.Scale < 0.4 then
                    Void.Config.UI.Scale = 0.4
                end
                InitInfo.Objects.MainScreenGuiScale.Scale = Void.Config.UI.Scale
                Assets.Config.Save("UI", Void.Config.UI)
            end
        ...
        InitInfo.Functions.CreateNavigationButton = function(Data: any)
            ...
            table.insert(Void.Connections, buttondata.Button.MouseEnter:Connect(function()
                hovergradient.Enabled = true
                TweenService:Create(iconscale, TweenInfo.new(0.15), {Scale = 1.2}):Play()
            end))
            table.insert(Void.Connections, buttondata.Button.MouseLeave:Connect(function()
                hovergradient.Enabled = false
                TweenService:Create(iconscale, TweenInfo.new(0.15), {Scale = 1}):Play()
            end))
            table.insert(Void.Connections, buttondata.Button.MouseButton1Click:Connect(function() 
        ...
        InitInfo.Functions.CreateWindowControlButton = function(Data: any)
            ...
            if buttondata.Drag then
                ...
                table.insert(Void.Connections, buttondata.Objects.Button.MouseButton1Click:Connect(function()
                ...
                if not Void.Mobile then
                    table.insert(Void.Connections, buttondata.Objects.Button.MouseEnter:Connect(function()
                        buttondata.Objects.Selection.ImageTransparency = 1
                    ...
                    table.insert(Void.Connections, buttondata.Objects.Button.MouseLeave:Connect(function()
                        TweenService:Create(ActualIconScale, TweenInfo.new(0.15), {Scale = 1}):Play()
            ...
            if HasInput then
                table.insert(Void.Connections, buttondata.Objects.Button.InputBegan:Connect(buttondata.Callbacks.InputBegan))
            end
        ...
        table.insert(Void.Connections, UserInputService.InputEnded:Connect(function(input)
            if Void.InputEndFunc then
                Void.InputEndFunc(input)
            end
        end))
    
        InitInfo.Functions.Resize = function(input : InputObject)
            if InitInfo.Data.Resizing and not Void.Config.UI.FullScreen then
                ...
                Void.Config.UI.Size = {X = newScaleX, Y = newScaleY}
            end
        end
        ...
        InitInfo.Functions.Drag = function(mouseStart: Vector2 | Vector3 | nil, frameStart: UDim2, input: InputObject?)
            ...
            pcall(function()
                if UserCamera then
                    ...
                    Void.Config.UI.Position = {X = newX, Y = newY}
                end
            end)
        end
        ...
        Void.CurrntInputChangeCallback = function() end 
        table.insert(Void.Connections, UserInputService.InputChanged:Connect(function(input)
            Void.CurrntInputChangeCallback(input)
        end))
            ...
            Callbacks = {
                Clicked = function(self)
                    if not forcefullscreen then
                        Void.Config.UI.FullScreen = not Void.Config.UI.FullScreen
                    end
                    
                    if Void.Config.UI.FullScreen or forcefullscreen then
                        if not forcefullscreen then
                            Void.Config.UI.Position = {X = InitInfo.Objects.MainFrame.Position.X.Scale, Y = InitInfo.Objects.MainFrame.Position.Y.Scale}
                            Void.Config.UI.Size = {X = InitInfo.Objects.MainFrame.Size.X.Scale, Y = InitInfo.Objects.MainFrame.Size.Y.Scale}
                            Void.Config.UI.Scale = InitInfo.Objects.MainFrameScale.Scale
                        else
                            Void.Config.UI.FullScreen = true
                        ...
                        TweenService:Create(InitInfo.Objects.MainFrame, TweenInfo.new(0.5, Enum.EasingStyle.Exponential), {Position = UDim2.fromScale(Void.Config.UI.Position.X, Void.Config.UI.Position.Y), Size = UDim2.fromScale(Void.Config.UI.Size.X, Void.Config.UI.Size.Y)}):Play()
                        for i,v in Void.Corners do
                            TweenService:Create(v, TweenInfo.new(0.5, Enum.EasingStyle.Exponential), {CornerRadius = UDim.new(0, 20)}):Play()
                        end
                        TweenService:Create(InitInfo.Objects.MainFrameScale, TweenInfo.new(0.5, Enum.EasingStyle.Exponential), {Scale = Void.Config.UI.Scale}):Play()
                    end
        ...
        InitInfo.Functions.CreateWindowControlButton({
            ...
            Callbacks = {
                InputBegan = function(input)
                    if (input.UserInputType == Enum.UserInputType.MouseButton1) or (input.UserInputType == Enum.UserInputType.Touch) then
                        if Void.Config.UI.FullScreen then 
    
                            Void.Config.UI.FullScreen = false
                        ...
                        Void.CurrntInputChangeCallback = function(input)
                            if (input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch) then  
                                if InitInfo.Data.Dragging and not Void.Config.UI.FullScreen then
                ...
                Clicked = function(self)
                    Void.ControlsVisible = not Void.ControlsVisible
                    if Void.ControlsVisible then
                    ...
                    if (input.UserInputType == Enum.UserInputType.MouseButton1) or (input.UserInputType == Enum.UserInputType.Touch) then
                        ...
                        Void.InputEndFunc = function(input)
                            if (input.UserInputType == Enum.UserInputType.MouseButton1) or (input.UserInputType == Enum.UserInputType.Touch) then
                                ...
                                Void.CurrntInputChangeCallback = function() end
                                Assets.Config.Save("UI", Void.Config.UI)
                                Void.InputEndFunc = function() end
                            end
                        end
                    end
                end
...
do 
    Assets.ArrayList.Init = function()
        local Data = {
            ...
            RainbowSpeed = 5000,
            Loaded = true,
            Objects = Void.ArrayList.Objects
        }
        ...
        local TEXT_SIZE = if Void.Mobile then 16 else 24
        ...
        local product_sans_id = Assets.Font.create_family("ProductSans", {
            {
                name = "Regular",
                weight = 400,
                file = "Void/Assets/Fonts/Product-Sans-Regular.ttf",
            },
        })
        ...
        function Data.Functions.Toggle(visible: boolean)
            Void.ArrayList.Objects.ArrayGui.Enabled = visible
            if not visible then
                ...
                if not Data.Connections.Rainbow then
                    ...
                    table.insert(Void.Connections, r)
                end
            end
        end

        Holder.Parent = Void.ArrayList.Objects.ArrayGui
...
do
    ...
    Assets.Pages.Init = function()
        ...
        InitInfo.Objects.Pageselector = Instance.new("Frame", Void.Background.Objects.MainFrame)
        ...
        table.insert(Void.Corners, InitInfo.Objects.PageselectorCorner)
        ...
        Void.Background.Functions.CreateNavigationButton({
            Name = "Menu", 
            Icon = "rbxassetid://11295285432", 
            Callback = function()
                InitInfo.Functions.ToggleSelectorVisibility(not Void.Pageselector.Objects.Pageselector.Visible)
            end
        })
    
        Void.Pageselector = InitInfo
        return InitInfo
    end
    ...
    Assets.Pages.NewPage = function(Data)
        ...
        if not Void.Pageselector then Assets.Pages.Init() end
        PageData.Objects.PageselectorButton = Instance.new("ImageButton", Void.Pageselector.Objects.PageselectorButtons)
        ...
        PageData.Objects.ActualPage = Instance.new("CanvasGroup", Void.Background.Objects.PageHolder)
        ...
        if PageData.Name == "Dashboard" then
            ...
            table.insert(Void.Connections, MainSearchBarTextBox.Focused:Connect(function()  
            ...
            table.insert(Void.Connections, MainSearchBarTextBox.FocusLost:Connect(function()  
            ...
            table.insert(Void.Connections, SearchBarClear.MouseButton1Click:Connect(function()
                Search("")
                TweenService:Create(SearchBarClearScale, TweenInfo.new(0.1), {Scale = 0}):Play()
            end))
        end

        table.insert(Void.Connections, PageData.Objects.PageselectorButton.MouseEnter:Connect(function()
        ...
        table.insert(Void.Connections, PageData.Objects.PageselectorButton.MouseLeave:Connect(function()
        ...
        table.insert(Void.Connections, PageData.Objects.PageselectorButton.MouseButton1Click:Connect(function()  
            Void.Pageselector.Functions.ToggleSelectorVisibility(false)
            for i,v in Void.Pages do
        ...
        Void.Pages[PageData.Name] = PageData
        return PageData
    end
...
do
    Assets.Dashboard.NewTab = function(data)
        local tab = {
            ...
            Dashboard = data and data.Dashboard or Void.Pages.Dashboard,
        ...
        if not Void.Tabs.TabBackground then
            Void.Tabs.TabBackground = Instance.new("ImageButton", Void.Background.Objects.MainFrame)
            Void.Tabs.TabBackground.AnchorPoint = Vector2.new(0.5, 0.5)
            Void.Tabs.TabBackground.BackgroundTransparency = 1
            Void.Tabs.TabBackground.Position = UDim2.fromScale(0.5, 0.5)
            Void.Tabs.TabBackground.Size = UDim2.fromScale(1, 1)
            Void.Tabs.TabBackground.Image = "rbxassetid://16286761786"
            Void.Tabs.TabBackground.ImageTransparency = 0.5
            Void.Tabs.TabBackground.ScaleType = Enum.ScaleType.Stretch
            Void.Tabs.TabBackground.Visible = false
            Void.Tabs.TabBackground.AutoButtonColor = false
            Instance.new("UICorner", Void.Tabs.TabBackground).CornerRadius = UDim.new(0, 20)
        end

        tab.Objects.ActualTab = Instance.new("ImageButton", Void.Tabs.TabBackground)
        ...
        tab.Objects.ActualTab.ImageColor3 = Color3.fromRGB(Void.Config.UI.TabColor.value1, Void.Config.UI.TabColor.value2, Void.Config.UI.TabColor.value3)
        tab.Objects.ActualTab.ImageTransparency = Void.Config.UI.TabTransparency
        ...
        if not Void.Config.Game.Other.TabPos then 
            Void.Config.Game.Other.TabPos = {}
        end
        if Void.Config.Game.Other.TabPos[tab.Name] then
            local pos = Void.Config.Game.Other.TabPos[tab.Name]
            if pos.X then
        ...
        tab.Functions.Drag = function(mouseStart: Vector2 | Vector3 | nil, frameStart: UDim2, input: InputObject?)
            pcall(function()
                if UserCamera then
                    ...
                    local newX = frameStart.X.Scale + (Delta.X / (Viewport.X / (Void.Background.Objects.MainFrame.Size.X.Scale + 2.13)))
                    ...
                    for i,v in Void.Tabs.Tabs do
                        if v.Objects and v.Objects.ActualTab then
                            ...
                            if TabPos.X.Scale > 0.9 or 0 > TabPos.X.Scale or TabPos.Y.Scale >= 0.95 or 0 > TabPos.Y.Scale then
                                if not flagged then
                                    local t = TweenService:Create(Void.Tabs.TabBackground, TweenInfo.new(0.8, Enum.EasingStyle.Exponential), {ImageTransparency = 1})
                                    t:Play()
                                    task.spawn(function()
                                        t.Completed:Wait()
                                        task.wait(0.1)
                                        if not flagged and Void.Tabs.TabBackground.ZIndex ~= -100 then
                                            Void.Tabs.TabBackground.ZIndex = -100
                                        end
                                    end)
                                end
                            else
                                if v.Objects.ActualTab.Visible then
                                    TweenService:Create(Void.Tabs.TabBackground, TweenInfo.new(0.8, Enum.EasingStyle.Exponential), {ImageTransparency = 0.5}):Play()
                                    Void.Tabs.TabBackground.ZIndex = 1
                                    flagged = true
                                end
                            end
                        end
                    ...
                    Void.Config.Game.Other.TabPos[tab.Name] = {X = newX, Y = newY}
                end
            end)
        end

        local InputStarting, FrameStarting = nil, nil
        table.insert(Void.Connections, tab.Objects.DragButton.InputBegan:Connect(function(input)
            if (input.UserInputType == Enum.UserInputType.MouseButton1) or (input.UserInputType == Enum.UserInputType.Touch) then
        ...
        CloseButton.BackgroundColor3 = Color3.fromRGB(Void.Config.UI.TabColor.value1 + 20, Void.Config.UI.TabColor.value2 + 20, Void.Config.UI.TabColor.value3 + 20)
        ...
        tab.Functions.ToggleTab = function(visible, anim, reopen)
            task.spawn(function()
                ...
                if visible then
                    if not reopen then
                        if not Void.CurrentOpenTab then
                            Void.CurrentOpenTab = {tab}
                        else
                            table.insert(Void.CurrentOpenTab, tab)
                        end
                    end

                    Void.Tabs.TabBackground.Visible = true
                    ...
                    if anim and Void.Config.UI.Anim then
                            ...
                            if v.Objects and v.Objects.ActualTab then
                                ...
                                if TabPos.X.Scale > 0.9 or 0 > TabPos.X.Scale or TabPos.Y.Scale >= 0.95 or 0 > TabPos.Y.Scale then
                                    if not flagged then
                                        ...
                                        Void.IsAllowedToHoverTabButton = false
                                    end
                                else
                                    if v.Objects.ActualTab.Visible and v ~= tab or v == tab then
                                        Void.Tabs.TabBackground.ZIndex = 1
                                        TweenService:Create(Void.Tabs.TabBackground, TweenInfo.new(0.8, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {ImageTransparency = 0.5}):Play()
                                        Void.IsAllowedToHoverTabButton = true
                                        flagged = true
                                    end
                                end
                            end
                        end
                        TweenService:Create(tab.Objects.ActualTab, TweenInfo.new(0.8, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {ImageTransparency = Void.Config.UI.TabTransparency}):Play()
                    ...
                    if not reopen then
                        table.remove(Void.CurrentOpenTab, table.find(Void.CurrentOpenTab, tab))
                    end
                    Void.IsAllowedToHoverTabButton = false
                    ...
                    local cnt = 0 
                    for i,v in Void.CurrentOpenTab do
                        cnt += 1
                    end
                    if 0 >= cnt then
                        Void.Tabs.TabBackground.Visible = false
        ...
        table.insert(Void.Connections, dashboardbuttonclickcon)


        local dashboardbuttonhovercon =  tab.Objects.DashBoardButton.MouseEnter:Connect(function()
            if not Void.IsAllowedToHoverTabButton then
        ...
        table.insert(Void.Connections, dashboardbuttonhovercon)
        ...
        table.insert(Void.Connections, dashboardbuttonleavecon)
        ...
        table.insert(Void.Connections, tabclosebuttoncon)
        ...
        table.insert(Void.Connections, searchclearcon)
        ...
        table.insert(Void.Connections, searchfocuslostcon)
        ...
        table.insert(Void.Connections, searchfocuscon)
        ...
        tab.Functions.NewModule = function(data)
            ...
            Backbutton.BackgroundColor3 = Color3.fromRGB(Void.Config.UI.TabColor.value1 + 20, Void.Config.UI.TabColor.value2 + 20, Void.Config.UI.TabColor.value3 + 20)
            ...
            KeyBindButton.BackgroundColor3 = Color3.fromRGB(Void.Config.UI.KeybindColor.value1, Void.Config.UI.KeybindColor.value2, Void.Config.UI.KeybindColor.value3)
            KeyBindButton.BackgroundTransparency = Void.Config.UI.KeybindTransparency
            ...
            table.insert(Void.Connections, moduleclickcon)
            ...
            ModuleData.Functions.Toggle = function(enabled: boolean, override: boolean, notify: boolean, save: boolean, updateArray: boolean)
                ...
                local Array
                if not Void.ArrayList.Loaded then
                    Array = Assets.ArrayList.Init()
                else
                    Array = Void.ArrayList
                end
                ...
                if enabled then
                    if not ModuleData.Data.Enabled or override then
                        ...
                        if notify and Void.Config.UI.Notifications then
                            Assets.Notifications.Send({
                ...
                if save then
                    Void.Config.Game.Modules[ModuleData.Flag] = enabled
                    Assets.Config.Save(Void.GameSave, Void.Config.Game)
                end
            end
                ...
                if not ModuleData.Data.Keybind then
                    local suc = pcall(function()
                        if not Void.Mobile then
                            ...
                            Void.Background.Functions.CreateMobileButton({
                                Name = ModuleData.Name,
                    ...
                    if Save and suc then
                        Void.Config.Game.Keybinds[ModuleData.Flag] = Bind
                        Assets.Config.Save(Void.GameSave, Void.Config.Game)
                    end
                end
            end
            ...
            ModuleData.Functions.UnbindKeybind = function(Save: boolean)
                if Void.Mobile then
                    if Void.Background.MobileButtons and Void.Background.MobileButtons.Buttons[ModuleData.Flag.."MobileButton"] and Void.Background.MobileButtons.Buttons[ModuleData.Flag.."MobileButton"].Functions then
                        Void.Background.MobileButtons.Buttons[ModuleData.Flag.."MobileButton"].Functions.Destroy()
                    end
                    KeyBindButton.Text = "TAP TO BIND"
                else
                ...
                KeybindInfoText.Text = "No Keybind Set"
                Void.Config.Game.Keybinds[ModuleData.Flag] = nil
                ModuleData.Data.Keybind = nil
            ...
            table.insert(Void.Connections, keybindbuttonpresscon)
            table.insert(ModuleData.Connections, keybindbuttonpresscon)

            if Void.Config.Game.Keybinds[ModuleData.Flag] then
                if Void.Config.Game.Keybinds[ModuleData.Flag] == "Binded" and Void.Mobile then
                    ModuleData.Functions.BindKeybind("Binded", false)
                else
                    ModuleData.Functions.BindKeybind(Void.Config.Game.Keybinds[ModuleData.Flag], false)
                end
            end
            ...
            table.insert(Void.Connections, keybindinputbegancon)
            ...
            table.insert(Void.Connections, togglebuttoncon)
            ...
            table.insert(Void.Connections, settingsbuttoncon)
            ...
            table.insert(Void.Connections, settingsbackbuttoncon)
            ...
            ModuleData.Functions.Settings.TextBox = function(data)
                ...
                if Void.Config.Game.TextBoxes[TextBoxData.Flag] then
                    TextBoxData.Default = Void.Config.Game.TextBoxes[TextBoxData.Flag]                
                end
                ...
                if Void.Mobile and TextBoxData.ToolTip == "Click to Enter A Value" then
                ...
                TextBoxData.Functions.SetValue = function(text: string, save: boolean)
                    if text and tostring(text) then
                        ...
                        Void.Config.Game.TextBoxes[TextBoxData.Flag] = text
                        if save then
                            Assets.Config.Save(Void.GameSave, Void.Config.Game)
                        end
                    end
                ...
                local actualtextboxfocuslostcon = ActualTextBox.FocusLost:Connect(function() 
                    ...
                    Void.Config.Game.TextBoxes[TextBoxData.Flag] = ActualTextBox.Text
                    Assets.Config.Save(Void.GameSave, Void.Config.Game)
                end)
                table.insert(Void.Connections, actualtextboxfocuslostcon)
            ...
            ModuleData.Functions.Settings.MiniToggle = function(data)
                ...
                if Void.Mobile and MiniToggleData.ToolTip == "Click to toggle" then
                ...
                MiniToggleData.Functions.Toggle = function(enabled, save, override)
                    ...
                    if save then
                        Void.Config.Game.MiniToggles[MiniToggleData.Flag] = enabled
                        Assets.Config.Save(Void.GameSave, Void.Config.Game)
                    end
                end
                ...
                table.insert(Void.Connections, minitoggleclickcon)
            ...
            ModuleData.Functions.Settings.Slider = function(data)
                ...
                if Void.Config.Game.Sliders[SliderData.Flag] then
                    if typeof(Void.Config.Game.Sliders[SliderData.Flag]) == "table" then
                        SliderData.Default = Void.Config.Game.Sliders[SliderData.Flag]
                    elseif typeof(Void.Config.Game.Sliders[SliderData.Flag]) == "number" then
                        SliderData.Default = {Value2 = Void.Config.Game.Sliders[SliderData.Flag]}
                    end
                else
                ...
                SliderData.Functions.SetValue = function(value: number, save: boolean, target: number)
                    ...
                    if value then
                        ...
                        if target == 2 then
                            if Void.Config.Game.Sliders[SliderData.Flag] and typeof(Void.Config.Game.Sliders[SliderData.Flag]) == "table" and Void.Config.Game.Sliders[SliderData.Flag].Value1 then
                                info = {Value1 = Void.Config.Game.Sliders[SliderData.Flag].Value1, Value2 = value}
                            end

                        elseif target == 1 then
                            info = {Value1 = value, Value2 = SliderData.Default.Value2}
                            if Void.Config.Game.Sliders[SliderData.Flag] and typeof(Void.Config.Game.Sliders[SliderData.Flag]) == "table" and Void.Config.Game.Sliders[SliderData.Flag].Value2 then
                                info = {Value1 = value, Value2 = Void.Config.Game.Sliders[SliderData.Flag].Value2}
                            end
                        else
                        ...
                        if save then
                            Void.Config.Game.Sliders[SliderData.Flag] = info
                            Assets.Config.Save(Void.GameSave, Void.Config.Game)
                        end
                    end
                end
                ...
                if SliderData.Multi then
                    ...
                    table.insert(Void.Connections, sliderdragbuttonclickcon2)
                    table.insert(ModuleData.Connections, sliderdragbuttonclickcon2)                                
                end

                local sliderdragbuttonclickcon
                if Void.Mobile and not SliderData.Multi then
                ...
                table.insert(Void.Connections, sliderdragbuttonclickcon)
                ...
                table.insert(Void.Connections, slidervaluetextchangecon)
                ...
                if SliderData.Multi then
                    ...
                    table.insert(Void.Connections, slidervaluetextchangecon2)
            ...
            ModuleData.Functions.Settings.Dropdown = function(data)
                ...
                if not Void.Config.Game.Dropdowns then
                    Void.Config.Game.Dropdowns = {}
                else
                    if Void.Config.Game.Dropdowns[DropdownData.Flag] then
                        DropdownData.Default = Void.Config.Game.Dropdowns[DropdownData.Flag]
                    end
                end
                ...
                DropdownData.Functions.SetValue = function(NewData: string | {}, Save: boolean)
                    if NewData then
                        ...
                        if Save then
                            Void.Config.Game.Dropdowns[DropdownData.Flag] = ReturnData
                            Assets.Config.Save(Void.GameSave, Void.Config.Game)
                        end
                    end
                end
                ...
                for i,v in DropdownData.Options do
                    ...
                    table.insert(Void.Connections, ClickCon)
                    ...
                    ButtonInfo.Functions.Destroy = function()
                        for i,v in ButtonInfo.Connections do
                            ...
                            local con2 = table.find(Void.Connections, v)
                            v:Disconnect()
                            if con1 then
                                table.remove(DropdownData.Connections, con1)
                            end
                            if con2 then
                                table.remove(Void.Connections, con2)
                            end
                        end
                    end
                ...
                table.insert(Void.Connections, OpenCon)
            ...
            ModuleData.Functions.Settings.Button = function(data: {Name: string, Flag: string, Description: string, ToolTip: string, Hide: boolean, Callback: any})
                ...
                if Void.Mobile and ButtonData.ToolTip == "Click to toggle" then
            ...
            ModuleData.Functions.Settings.Keybind = function(Data: {Name: string, Description: string, Default: string, ToolTip: string, Hide: boolean, Flag: string, Callbacks: {Began: () -> (), End: () -> (), Changed: () -> ()}, Mobile: {Text: string, Default: boolean, Visible: boolean}})
                ...
                if not Void.Config.Game.ModuleKeybinds then
                    Void.Config.Game.ModuleKeybinds = {}
                else
                    if Void.Config.Game.ModuleKeybinds[KeybindData.Flag] then
                        if Void.Config.Game.ModuleKeybinds[KeybindData.Flag] == "unbinded" then
                            KeybindData.Default = ""
                        else
                            KeybindData.Default = Void.Config.Game.ModuleKeybinds[KeybindData.Flag]
                        end
                    else
                ...
                if Void.Mobile then
                    table.insert(ModuleData.onToggles, function(self, enabled)
                        if enabled then
                            ...
                            if Void.Background.MobileButtons.Buttons[KeybindData.Flag.."MobileKeybind"] then
                                Void.Background.MobileButtons.Buttons[KeybindData.Flag.."MobileKeybind"].Functions.Destroy()
                            end
                        end
                    end)
                end
                ...
                if tostring(KeybindData.Default):gsub(" ", "") ~= "" then
                    ...
                    if Void.Mobile and tostring(KeybindData.Default) == "button" then
                    ...
                    elseif Void.Mobile and tostring(KeybindData.Default) == "unbinded" then
                ...
                local ClickCon = KeybindBox.MouseButton1Down:Connect(function()
                    if not KeybindData.Data.Keybind then
                        if Void.Mobile then
                            ...
                            if not Void.Background.MobileButtons.Buttons[KeybindData.Flag.."MobileKeybind"] and ModuleData.Data.Enabled then
                                Void.Background.Functions.CreateMobileButton({
                                    Name = KeybindData.Mobile.Text,
                                    Flag = KeybindData.Flag.."MobileKeybind",
                                    Callbacks = {
                            ...
                            Void.Config.Game.ModuleKeybinds[KeybindData.Flag] = "button"
                            Void.Assets.Config.Save(tostring(Void.GameSave), Void.Config.Game)
                        else
                        ...
                        Void.Config.Game.ModuleKeybinds[KeybindData.Flag] = nil
                        if Void.Mobile then
                            Void.Config.Game.ModuleKeybinds[KeybindData.Flag] = "unbinded"
                        end
                        Void.Assets.Config.Save(tostring(Void.GameSave), Void.Config.Game)
                    end
                end)
                ...
                local CallbackCon = UserInputService.InputBegan:Connect(function(input)
                    ...
                    if KeybindData.Data.Binding then
                        if input.KeyCode and input.KeyCode.Name ~= "Unknown" then
                            ...
                            Void.Config.Game.ModuleKeybinds[KeybindData.Flag] = input.KeyCode.Name
                            Void.Assets.Config.Save(tostring(Void.GameSave), Void.Config.Game)
                        end
                    else
                ...
                table.insert(Void.Connections, CallbackCon)

                table.insert(KeybindData.Connections, EndCon)
                table.insert(Void.Connections, EndCon)

                table.insert(KeybindData.Connections, HoverCon)
                table.insert(Void.Connections, HoverCon)
                
                table.insert(KeybindData.Connections, UnHoverCon)
                table.insert(Void.Connections, UnHoverCon)
                ...
                KeybindData.Functions.SetValue = function(NewValue: string, save: boolean)
                    if not NewValue or NewValue == "" or NewValue == "unbinded" then
                        ...
                        if save then
                            Void.Config.Game.ModuleKeybinds[KeybindData.Flag] = NewValue
                            Void.Assets.Config.Save(tostring(Void.GameSave), Void.Config.Game)
                        end
                    end
                end
            ...
            SectionData.Functions.NewButton = function(data)
                ...
                if ButtonData.Toggle then
                    ...
                    if ButtonData.Flag then
                        if Void.Config.UI[ButtonData.Flag] == nil and ButtonData.Default or Void.Config.UI[ButtonData.Flag] then
                ...
                if ButtonData.Textbox then
                    ...
                    if ButtonData.Default and typeof(ButtonData.Default) == "string" and Void.Config.UI[ButtonData.Flag] == nil then
                        Textbox.Text = ButtonData.Default
                    end
                    if Void.Config.UI[ButtonData.Flag] then
                        if typeof(Void.Config.UI[ButtonData.Flag]) == "table" then
                            for i,v in Void.Config.UI[ButtonData.Flag] do
                                Textbox.Text = Textbox.Text .. tostring(v) .. ", "
                            end
                            Textbox.Text = string.sub(Textbox.Text, 0, #Textbox.Text-2)
                        else
                            Textbox.Text = tostring(Void.Config.UI[ButtonData.Flag])
                        end
                    end

                    table.insert(Void.Connections, Textbox.FocusLost:Connect(function()
                ...
                table.insert(Void.Connections, ButtonData.Objects.MainButton.MouseButton1Click:Connect(function() 
                    if ButtonData.Toggle then
...
do    
    if not Voidthen 
        LocalPlayer:Kick("Void not supported/couldn't load global environment")
        return 
    end
    ...
    Assets.Main.Uninject = function()
        ...
        Void.Background.Objects.MainScreenGui:Destroy()
        Void.Notifications.Objects.NotificationGui:Destroy()
        Void.ArrayList.Objects.ArrayGui:Destroy()

        if Void.Mobile then
            for i,v in Void.Background.MobileButtons.Buttons do
                if v and v.Functions and v.Functions.Destroy then
                    v.Functions.Destroy()
                end
            end
        ...
        for i,v in Void.Connections do
            v:Disconnect()
        end
        
        Assets.Main.OnUninject:Destroy()
        table.clear(getgenv().Void)
        getgenv().Void = nil
    end

    local cantogglewithkeybind = true
    Assets.Main.Load = function(file)
        if not Void.Background then
            Void.Background = Assets.MainBackground.Init()
        end

        if not Void.Dashboard then
            Void.Dashboard = Assets.Pages.NewPage({
                Name = "Dashboard",
            ...
            MainSettings.Functions.NewButton({Name = "Change Keybind", Callback = function(self)
                ...
                changecon = UserInputService.InputBegan:Connect(function(input)
                    if input and input.KeyCode.Name ~= "Unknown" then
                        ...
                        Void.Config.UI.ToggleKeyCode = input.KeyCode.Name
                        Assets.Config.Save("UI", Void.Config.UI)
                        task.wait(1)
                ...
                table.insert(Void.Connections, changecon)
            end})
            ...
            ThemeSettings.Functions.NewButton({Name = "TabColor", Textbox = true, Flag = "TabColor", Default = "70, 70, 70", Callback = function(self, value)
                ...
                if #split == 3 then
                    ...
                    if tonumber(v1) and tonumber(v2) and tonumber(v3) then
                        Void.Config.UI.TabColor = {value1 = tonumber(v1), value2 = tonumber(v2), value3 = tonumber(v3)}
                        Assets.Config.Save("UI", Void.Config.UI)
                        for i,v in Void.Tabs.Tabs do
            ...
            ThemeSettings.Functions.NewButton({Name = "TabTransparency", Textbox = true, Flag = "TabTransparency", Default = "0.1", Callback = function(self, value)
                if tonumber(value) then
                    Void.Config.UI.TabTransparency = tonumber(value)
                    for i,v in Void.Tabs.Tabs do
                        v.Objects.ActualTab.ImageTransparency = Void.Config.UI.TabTransparency
                    end
                    Assets.Config.Save("UI", Void.Config.UI)
                end
            end})
            ThemeSettings.Functions.NewButton({Name = "KeybindColor", Textbox = true, Flag = "KeybindColor", Default = "85, 89, 91", Callback = function(self, value)
                ...
                if #split == 3 then
                    local v1, v2, v3 = split[1]:gsub(" ", ""), split[2]:gsub(" ", ""), split[3]:gsub(" ", "")
                    if tonumber(v1) and tonumber(v2) and tonumber(v3) then
                        Void.Config.UI.KeybindColor = {value1 = tonumber(v1), value2 = tonumber(v2), value3 = tonumber(v3)}
                        Assets.Config.Save("UI", Void.Config.UI)
                        for i,v in Void.Tabs.Tabs do
            ...
            ThemeSettings.Functions.NewButton({Name = "KeybindTransparency", Textbox = true, Flag = "KeybindTransparency", Last = true, Default = "0.015", Callback = function(self, value)
                if tonumber(value) then
                    Void.Config.UI.KeybindTransparency = tonumber(value)
                    Assets.Config.Save("UI", Void.Config.UI)
                    for i,v in Void.Tabs.Tabs do
                        if v.Objects.ActualTab:FindFirstChildWhichIsA("TextButton") then
            ...
            return {Background = Void.Background, Dashboard = Void.Dashboard, Settings = Settings}
        else
            Assets.Functions.LoadFile("Night/Games/"..file..".lua", "https://raw.githubusercontent.com/null-wtf/Night/refs/heads/main/Night/Games/"..file..".lua")
            Assets.Config.Load(Void.GameSave, "Game")
            return {Background = Void.Background, Dashboard = Void.Dashboard}
        end
    end
    ...
    Assets.Main.ToggleVisibility = function(visible: boolean)
        do
            ...
            if not Void.Config.UI.Anim then
                Void.Background.Objects.MainFrame.Visible = visible
                if visible then
                    Void.Background.Objects.MainFrame.BackgroundTransparency = 0.1
                    Void.Background.Objects.MainFrame.ImageTransparency = 0.8
                    Void.Background.Objects.MainFrameScale.Scale = 1
                    Void.Background.Objects.WindowControls.GroupTransparency = 0.4
                end
                return
            end
            ...
            if visible then
                if Void.Mobile then
                    Void.Background.Objects.ToggleButton.Visible = false
                end
                Void.Background.Objects.MainFrame.Visible = true
                Void.Background.Objects.DropShadow.Visible = true
                
                Void.Background.Objects.MainFrame.BackgroundTransparency = 1
                Void.Background.Objects.MainFrame.ImageTransparency = 1
                Void.Background.Objects.MainFrameScale.Scale = 1
                Void.Background.Objects.WindowControls.GroupTransparency = 1

                table.insert(RunningTweens, TweenService:Create(Void.Background.Objects.MainFrame, TweenInfo.new(1.2, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {BackgroundTransparency = 0.1, ImageTransparency = 0.8}))
                table.insert(RunningTweens, TweenService:Create(Void.Background.Objects.WindowControls, TweenInfo.new(0.8, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {GroupTransparency = 0.4}))
                ...
                if Void.Notifications.Active.discordnoti then
                    Void.Notifications.Active.discordnoti.Functions.Remove(true)
                end
                if Void.Mobile then
                    Void.Background.Objects.ToggleButton.Visible = true
                end
                ...
                if Void.Tabs.TabBackground.Visible then
                    Void.Tabs.TabBackground.Visible = false
                end

                table.insert(RunningTweens, TweenService:Create(Void.Background.Objects.MainFrame, TweenInfo.new(1.2, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {BackgroundTransparency = 1, ImageTransparency = 1}))
                table.insert(RunningTweens, TweenService:Create(Void.Background.Objects.WindowControls, TweenInfo.new(0.8, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {GroupTransparency = 1}))

                for i,v in RunningTweens do v:Play() end

                if Void.Pageselector.Objects.Pageselector.Visible then
                    Void.Pageselector.Objects.Pageselector.Visible = false
                    table.insert(Restore, Void.Pageselector.Objects.Pageselector)
                end

                Void.Background.Objects.NavigationButtons.Visible = false
                table.insert(Restore, Void.Background.Objects.NavigationButtons)
                Void.Background.Objects.WindowControls.Visible = false
                table.insert(Restore, Void.Background.Objects.WindowControls)
                ...
                Void.Background.Objects.DropShadow.Visible = false

                task.delay(0.8, function()
                    Void.Background.Objects.MainFrame.Visible = Open
                end)
            end
        end
    end
    table.insert(Void.Connections, UserInputService.InputBegan:Connect(function(input, gameProcessed)
        if gameProcessed and UserInputService:GetFocusedTextBox() or not cantogglewithkeybind then return end
        if input.KeyCode.Name == Void.Config.UI.ToggleKeyCode then
            Assets.Main.ToggleVisibility(not Void.Background.Objects.MainFrame.Visible)
        end
    end))
...
Void.Assets = Assets
return Assets
ackground.Objects.MainFrame.Visible)
        end
    end))
