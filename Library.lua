...
AutoParryGroup:AddDropdown("CurveDirection", {
    Values = { "Camera", "Slow Ball", "Random", "Backwards", "Straight", "High", "Left", "Right", "Random Target" },
    Default = "Camera",
...
DetectionGroup:AddToggle("SlashOfFury", {
    Text = "Slash of Fury",
    Default = false,
    Callback = function(v)
...
DetectionGroup:AddToggle("DeathSlash", {
    Text = "Death Slash",
    Default = false,
    Callback = function(v)
...
DetectionGroup:AddToggle("TimeHole", {
    Text = "Time Hole",
    Default = false,
    Callback = function(v)
