getgenv().GG = {
    Language = {
        ...
        ModuleDisabled = "DisabContainer.Backgroundled",
        TabGeneral = "General",
...
function Library:create_ui()
    ...
    Container.BorderColor3 = Color3.fromRGB(42, 42, 47)
    ...
    Handler.BorderColor3 = Color3.fromRGB(42, 42, 47)
    Handler.Size = UDim2.new(0, 698, 0, 479)
    Handler.BorderSizePixel = 0
    Handler.BackgroundColor3 = Color3.fromRGB(15, 15, 20)
    ...
    Tabs.BorderColor3 = Color3.fromRGB(42, 42, 47)
    ...
    ClientName.BorderColor3 = Color3.fromRGB(42, 42, 47)
    ClientName.TextSize = 13
    ClientName.BackgroundColor3 = Color3.fromRGB(15, 15, 20)
    ...
    Pin.BorderColor3 = Color3.fromRGB(42, 42, 47)
    Pin.Size = UDim2.new(0, 2, 0, 16)
    Pin.BorderSizePixel = 0
    Pin.BackgroundColor3 = Color3.fromRGB(15, 15, 20)
    Pin.Parent = Handler
    ...
    Divider.BorderColor3 = Color3.fromRGB(42, 42, 47)
    Divider.Size = UDim2.new(0, 1, 0, 479)
    Divider.BorderSizePixel = 0
    Divider.BackgroundColor3 = Color3.fromRGB(15, 15, 20)
    ...
    Minimize.BorderColor3 = Color3.fromRGB(42, 42, 47)
    Minimize.Text = ''
    ...
    function self:create_tab(title: string, icon: string)
        ...
        Tab.BorderColor3 = Color3.fromRGB(42, 42, 47)
        Tab.Text = ''
        ...
        TextLabel.BorderColor3 = Color3.fromRGB(42, 42, 47)
        TextLabel.TextSize = 13
        TextLabel.BackgroundColor3 = Color3.fromRGB(15, 15, 20)
        ...
        Icon.BorderColor3 = Color3.fromRGB(42, 42, 47)
        Icon.AnchorPoint = Vector2.new(0, 0.5)
        Icon.BackgroundTransparency = 1
        ...
        LeftSection.BorderColor3 = Color3.fromRGB(42, 42, 47)
        LeftSection.BackgroundColor3 = Color3.fromRGB(15, 15, 20)
        ...
        RightSection.BorderColor3 = Color3.fromRGB(42, 42, 47)
        RightSection.BackgroundColor3 = Color3.fromRGB(15, 15, 20)
        ...
        function TabManager:create_module(settings: any)
            ...
            Module.BorderColor3 = Color3.fromRGB(42, 42, 47)
            Module.BackgroundTransparency = 0.5
            Module.Position = UDim2.new(0.004115226212888956, 0, 0, 0)
            Module.Name = 'Module'
            Module.Size = UDim2.new(0, 241, 0, 93)
            Module.BorderSizePixel = 0
            Module.BackgroundColor3 = Color3.fromRGB(15, 15, 20)
            ...
            Header.BorderColor3 = Color3.fromRGB(42, 42, 47)
            Header.Text = ''
            ...
            ModuleName.BorderColor3 = Color3.fromRGB(42, 42, 47)
            ModuleName.TextSize = 13
            ModuleName.BackgroundColor3 = Color3.fromRGB(15, 15, 20)
            ...
            Description.BorderColor3 = Color3.fromRGB(42, 42, 47)
            Description.TextSize = 10
            Description.BackgroundColor3 = Color3.fromRGB(15, 15, 20)
            ...
            Keybind.BorderColor3 = Color3.fromRGB(42, 42, 47)
            Keybind.Size = UDim2.new(0, 33, 0, 15)
            Keybind.BorderSizePixel = 0
            Keybind.BackgroundColor3 = Color3.fromRGB(15, 15, 20)
            ...
            Options.BorderColor3 = Color3.fromRGB(42, 42, 47)
            Options.Size = UDim2.new(0, 241, 0, 8)
            Options.BorderSizePixel = 0
            Options.BackgroundColor3 = Color3.fromRGB(15, 15, 20)
            ...
            function ModuleManager:create_paragraph(settings: any)
                ...
                Paragraph.BackgroundColor3 = Color3.fromRGB(15, 15, 20)
            ...
            function ModuleManager:create_text(settings: any)
                ...
                TextFrame.BackgroundColor3 = Color3.fromRGB(15, 15, 20)
            ...
            function ModuleManager:create_textbox(settings: any)
                ...
                Textbox.BorderColor3 = Color3.fromRGB(42, 42, 47)
            ...
            function ModuleManager:create_checkbox(settings: any)
                ...
                KeybindBox.BackgroundColor3 = Color3.fromRGB(15, 15, 20)
                ...
                Box.BorderColor3 = Color3.fromRGB(42, 42, 47)
                ...
                Fill.BorderColor3 = Color3.fromRGB(42, 42, 47)
                Fill.Name = "Fill"
                Fill.BorderSizePixel = 1
                Fill.BackgroundColor3 = Color3.fromRGB(15, 15, 20)
                Fill.Parent = Box
            ...
            function ModuleManager:create_divider(settings: any)
                ...
                if not settings or settings and not settings.disableline then
                    ...
                    Divider.BackgroundColor3 = Color3.fromRGB(15, 15, 20) -- White color
                    Divider.BorderSizePixel = 0.5
                    Divider.Name = 'Divider'
            ...
            function ModuleManager:create_slider(settings: any)
                ...
                Value.BorderColor3 = Color3.fromRGB(42, 42, 47)
                Value.TextSize = 10
                Value.BackgroundColor3 = Color3.fromRGB(15, 15, 20)
                Value.Parent = Slider
            ...
            function ModuleManager:create_dropdown(settings: any)
                ...
                Dropdown.BorderColor3 = Color3.fromRGB(42, 42, 47)
                Dropdown.Text = ''
                Dropdown.AutoButtonColor = false
                Dropdown.BackgroundTransparency = 1
                Dropdown.Name = 'Dropdown'
                Dropdown.Size = UDim2.new(0, 207, 0, 39)
                Dropdown.BorderSizePixel = 1.0
                Dropdown.TextSize = 14
                Dropdown.BackgroundColor3 = Color3.fromRGB(15, 15, 20)
                ...
                CurrentOption.BorderColor3 = Color3.fromRGB(42, 42, 47)
                CurrentOption.TextSize = 10
                CurrentOption.BackgroundColor3 = Color3.fromRGB(15, 15, 20)
                ...
                Arrow.BorderColor3 = Color3.fromRGB(42, 42, 47)
                ...
                Options.ScrollBarImageColor3 = Color3.fromRGB(235, 235, 245)
                Options.Active = true
                ...
                if #settings.options > 0 then
                    ...
                    for index, value in settings.options do
                        ...
                        Option.BorderColor3 = Color3.fromRGB(42, 42, 47)
                        ...
                        Option.BackgroundColor3 = Color3.fromRGB(15, 15, 20)
            ...
            function ModuleManager:create_feature(settings)
                ...
                FeatureButton.BackgroundColor3 = Color3.fromRGB(15, 15, 20)
...
local function UseSwapAbility()
    if Abilities:FindFirstChild("Swap") and Abilities.Swap.Enabled then
        ...
        -- Executa Swap sem mexer na cĂ¢mera
...
do
    ...
    module:create_slider({
        ...
        callback = function(value: boolean)
           Speed_Divisor_Multiplier = 0.7 + (value - 1) * (0.34 / 99)
	end
})
    ...
    if now - lastAutoSpam < 0.00001 then return end
    lastAutoSpam = now
                local Ball = Auto_Parry.Get_Ball()
                ...
                if Ball_Target == tostring(Player) and Target_Distance > 100 and Distance > 70 then
                    return
                end
...
if tick() - (Last_Parry or 0) < 0.00001 then return end
Last_Parry = tick()
                            VirtualInputManager:SendKeyEvent(true, Enum.KeyCode.F, false, game) 
                        end
                    end)
...
-- MĂ³dulo principal de animaĂ§Ăµes
